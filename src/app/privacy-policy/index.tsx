    ...
    return (
        <div className={s.privacy_policy}>
            ...
            <ul>
                ...
                <li><a href="#data-collection">How We Collect Your Information</a></li>
                <li><a href="#use-of-data">How We Use Your Information</a></li>
                <li><a href="#security-measures">Security Measures and Data Protection</a></li>
                <li><a href="#user-rights-and-choices">Your Rights and Choices</a></li>
                <li><a href="#corrections">How to Correct or Delete Your Information</a></li>
            ...
            <ul>
                <li><strong>Access Your Information:</strong> You may access your personal information by providing us with written notice at [contact@yourcompany.com](mailto:contact@yourcompany.com).</li>
            ...
            <p>Please contact us at contact@fitdata.com with your request for corrections, deletions, or updates to your personal information.</p>
